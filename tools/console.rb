...
stupid = Cult.new("Stupid", "here, WA", 2019, "poop poop")
newbies = Cult.new("Newbies", "here, WA", 2020, "cuuuuuults!!!")
oldies = Cult.new("Oldies", "there, WA", 2010, "we're old")
exist = Cult.new("Existentials", "nowhere, WA", 0, "beuwqihbweqhufer")

exists = Follower.new("Doesn't Matter", 25, "nothing matters")
old = Follower.new("Old Guy", 95, "my back hurts")
dumb = Follower.new("Dumb Guy", 30, "I don't understand")
